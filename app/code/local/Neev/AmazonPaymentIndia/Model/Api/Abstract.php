 ...
 */
abstract class Neev_AmazonPaymentIndia_Model_Api_Abstract extends Neev_AmazonPaymentIndia_Model_Abstract {
    ...
    protected function _getApiClient() {
        if (null === $this->_apiClient) {
            ...
            if (class_exists($apiClientClass, true)) {
                ...
                Mage::helper('amazonpaymentindia')->throwException('API client class not specified or does not exist', null, array('area' => $this->_area));
            }
    ...
    protected function _getApiServer() {
        if (null === $this->_apiServer) {
            ...
            if (class_exists($apiServerClass, true)) {
                ...
                Mage::helper('amazonpaymentindia')->throwException('API server class not specified or does not exist', null, array('area' => $this->_area));
            }
