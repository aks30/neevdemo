 ...
 * <li>ShippingAddress: Neev_AmazonPaymentIndia_Model_Api_Model_Marketplace_Orders_Address</li>
 * <li>OrderTotal: Neev_AmazonPaymentIndia_Model_Api_Model_Marketplace_Orders_Money</li>
 * <li>NumberOfItemsShipped: int</li>
 * <li>NumberOfItemsUnshipped: int</li>
 * <li>PaymentExecutionDetail: Neev_AmazonPaymentIndia_Model_Api_Model_Marketplace_Orders_PaymentExecutionDetailItemList</li>
...
*/
class Neev_AmazonPaymentIndia_Model_Api_Model_Marketplace_Orders_Order extends Neev_AmazonPaymentIndia_Model_Api_Model_Marketplace_Orders_Abstract {
    ...
    public function __construct($data = null) {
        $this->_fields = array(
            ...
            'ShippingAddress' => array('FieldValue' => null, 'FieldType' => 'Neev_AmazonPaymentIndia_Model_Api_Model_Marketplace_Orders_Address'),
            'OrderTotal' => array('FieldValue' => null, 'FieldType' => 'Neev_AmazonPaymentIndia_Model_Api_Model_Marketplace_Orders_Money'),
            'NumberOfItemsShipped' => array('FieldValue' => null, 'FieldType' => 'int'),
            'NumberOfItemsUnshipped' => array('FieldValue' => null, 'FieldType' => 'int'),
            'PaymentExecutionDetail' => array('FieldValue' => null, 'FieldType' => 'Neev_AmazonPaymentIndia_Model_Api_Model_Marketplace_Orders_PaymentExecutionDetailItemList'),
