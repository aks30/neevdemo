 ...
 */
class Neev_AmazonPaymentIndia_Model_Api_Marketplace_Reports
    extends Neev_AmazonPaymentIndia_Model_Api_Abstract
    implements Neev_AmazonPaymentIndia_Model_Api_Interface_Marketplace_Reports {
    ...
    public function getReportList() {
        $request = $this->_getApiModel('request_getReportList', array(
            ...
            'ReportTypeList'    => array(
                'Type' => array(Neev_AmazonPaymentIndia_Model_Api_Model_Marketplace_Reports_Abstract::REPORT_TYPE_ORDERS_DATA)
            )
        ));
    ...
    public function manageReportSchedule($schedule) {
        $request = $this->_getApiModel('request_manageReportSchedule', array(
            'ReportType'    => Neev_AmazonPaymentIndia_Model_Api_Model_Marketplace_Reports_Abstract::REPORT_TYPE_ORDERS_DATA,
            'Schedule'      => $schedule
        ));
