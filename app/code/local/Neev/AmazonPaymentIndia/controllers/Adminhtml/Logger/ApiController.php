 ...
 */
class Neev_AmazonPaymentIndia_Adminhtml_Logger_ApiController extends Mage_Adminhtml_Controller_Action {

    protected function _getModel() {
        return Mage::getModel('amazonpaymentindia/log_api');
    }

    protected function _initAction() {
        $this->loadLayout()->_setActiveMenu('creativestyle/amazonpaymentindia/logger/api');
        return $this;
    }
    ...
    protected function _setTitle($title = null) {
        $this->_title(Mage::helper('amazonpaymentindia')->__('Checkout by Amazon'))
            ->_title(Mage::helper('amazonpaymentindia')->__('Amazon API calls'));
    ...
    public function viewAction() {
        ...
        if ($logModel->getId()) {
            ...
            $this->_addContent($this->getLayout()->createBlock('amazonpaymentindia/adminhtml_logger_api_view')->setLogModel($logModel));
            $this->renderLayout();
        } else {
