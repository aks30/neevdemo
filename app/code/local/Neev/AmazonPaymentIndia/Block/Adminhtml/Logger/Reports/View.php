 ...
 */
class Neev_AmazonPaymentIndia_Block_Adminhtml_Logger_Reports_View extends Mage_Adminhtml_Block_Widget_Container {
    ...
    public function __construct() {
        ...
        $this->setTemplate('neev/amazonpaymentindia/logger/reports/view.phtml');
        ...
        $this->_addButton('content_button', array(
            'label'     => Mage::helper('amazonpaymentindia')->__('Show report content'),
            'class'     => 'scalable'
        ));
    ...
    public function getReportType() {
        $reportTypeOptions = Mage::getModel('amazonpaymentindia/lookup_report_type')->getOptions();
