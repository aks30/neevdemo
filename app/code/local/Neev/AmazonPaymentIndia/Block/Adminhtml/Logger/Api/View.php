 ...
 */
class Neev_AmazonPaymentIndia_Block_Adminhtml_Logger_Api_View extends Mage_Adminhtml_Block_Widget_Container {
    ...
    public function __construct() {
        ...
        $this->setTemplate('neev/amazonpaymentindia/logger/api/view.phtml');
    ...
    public function getFormattedReportContent() {
        ...
        return $this->helper('amazonpaymentindia')->prettifyXml($this->getLogModel()->getReportContent(), true);
    }
    ...
    public function getFileData() {
        return $this->helper('amazonpaymentindia')->prettifyXml($this->getLogModel()->getFileData(), true);
    }
    ...
    public function getResponse() {
        return $this->helper('amazonpaymentindia')->prettifyXml($this->getLogModel()->getResponse(), true);
    }
