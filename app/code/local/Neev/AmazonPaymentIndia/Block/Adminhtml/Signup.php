 ...
 */
class Neev_AmazonPaymentIndia_Block_Adminhtml_Signup extends Mage_Adminhtml_Block_System_Config_Form_Fieldset {

    public function render(Varien_Data_Form_Element_Abstract $element) {
        $output = '';
        foreach ($element->getSortedElements() as $field) {
            $id = $field->getHtmlId();
            $output .= '<div class="neev-info" id="container_' . $id . '"' . (!$field->getValue() ? ' style="display:none;"' : '') . '>';
