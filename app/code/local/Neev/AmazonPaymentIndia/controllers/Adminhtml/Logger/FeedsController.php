 ...
 */
class Neev_AmazonPaymentIndia_Adminhtml_Logger_FeedsController extends Mage_Adminhtml_Controller_Action {

    protected function _getModel() {
        return Mage::getModel('amazonpaymentindia/log_feed');
    }

    protected function _initAction() {
        $this->loadLayout()->_setActiveMenu('creativestyle/amazonpaymentindia/logger/feeds');
        return $this;
    }
    ...
    protected function _setTitle($title = null) {
        $this->_title(Mage::helper('amazonpaymentindia')->__('Checkout by Amazon'))
            ->_title(Mage::helper('amazonpaymentindia')->__('Amazon MWS Feeds'));
    ...
    public function viewAction() {
        ...
        if ($logModel->getId()) {
            ...
            $this->_addContent($this->getLayout()->createBlock('amazonpaymentindia/adminhtml_logger_feeds_view')->setLogModel($logModel));
            $this->renderLayout();
        } else {
